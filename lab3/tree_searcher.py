...
def TEST_1(expected):
	...
	print "make_tree(tup_tree): {}".format()
...
def TEST_3(expected):
	...
	tree = make_tree(tup_tree)
	print "\n"
	print "type of tree: {}".format(type(tree))
	print "tree.num_children(): {}".format(tree.num_children())
	# print "type of tree.node_type: {}".format(tree.node_type)
	# print "tree.children: {}".format(tree.children)
	# print "tree.children.__len__(): {}".format(tree.children.__len__())
	# for i in tree.children:
	# 	print i, "type: {}".format(type(i))
	# 	print "i.node_type: {}".format(i.node_type)
